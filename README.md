...
This project demonstrates fundamental machine learning concepts by implementing a one-layer neural network.
The system learns to distinguish between four different languages using only the statistical distribution of letters A-Z in the text.

Architecture

26 input neurons – normalized frequency of letters a-z

N output neurons – one perceptron per language (minimum 4 languages)
